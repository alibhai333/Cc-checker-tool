...
if __name__ == "__main__":
    try:
        ...
        st.info("Please check your dependencies: pip install streamlit pandas plotly openpyxl")            "65": {"issuer": "DISCOVER", "type": "Credit", "country": "US", "bank": "Discover", "category": "MILES"},
        }
...
if __name__ == "__main__":
    app = UltimateStripeCheckerPro()
    app.run()            "65": {"issuer": "DISCOVER", "type": "Credit", "country": "US", "bank": "Discover", "category": "MILES"},
        }
